...
class Contacto(models.Model):
    id = models.AutoField(primary_key=True, auto_created=True)
    nombre = models.TextField(null=False, max_length=100, verbose_name="Nombre Contacto")
    correo = models.TextField(null=False, max_length=50, verbose_name="Correo Contacto")
    celular = models.IntegerField(null=False, verbose_name="Celular Contacto")
    Descripcion = models.TextField(null=False, verbose_name="Descrip Contacto")